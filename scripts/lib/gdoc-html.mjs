...
// Markdown Google принимает, но выбрасывает <mark> — заливка маркера теряется.
// Через HTML доезжает всё: заливка, таблицы, заголовки, служебный курсив пометок.

const HL_FILL = '#ffe066';
const SERVICE_INK = '#777777';
